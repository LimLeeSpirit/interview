 ...
 * 不带虚拟节点的一致性Hash算法
 */
public class ConsistingHash implements Serializable {

    // just test Serializable without-serialVersionUID inspections, option + enter 修复
    private static final long serialVersionUID = 5509346085827612743L;
